...
const videoProjects = [
  { id: 1,  client: "Taxes India",       subtitle: "Assignment",        videoUrl: "/videos/taxes-india.mp4",         thumbnailTime: 48  },
  { id: 2,  client: "Agyaat Khat",       subtitle: "Animated Intro",    videoUrl: "/videos/agyaat-khat-intro.mp4",   thumbnailTime: 3.1 },
  { id: 3,  client: "SaaS VFX AI",       subtitle: "Intro Video",       videoUrl: "/videos/vfx-ai-intro.mp4",        thumbnailTime: 0.1 },
  { id: 4, client: "Agyaat Khat",       subtitle: "Short Series",      videoUrl: "/videos/agyaat-khat.mp4",         thumbnailTime: 0.1 },
  { id: 5,  client: "Across Web3",       subtitle: "DeFi Night",        videoUrl: "/videos/across-defi.mp4",         thumbnailTime: 0.1 },
  { id: 6,  client: "SaaS VFX AI",       subtitle: "Explainer Video",   videoUrl: "/videos/vfx-ai-explainer.mp4",    thumbnailTime: 0.1 },
  { id: 7,  client: "Devlearn",          subtitle: "Community Pitch",   videoUrl: "/videos/devlearn.mp4",            thumbnailTime: 1.1 },
  { id: 8,  client: "Across Web3",       subtitle: "Infotainment",      videoUrl: "/videos/across-info.mp4",         thumbnailTime: 0.1 },
  { id: 9, client: "Aurat Jaat",        subtitle: "Short Series",      videoUrl: "/videos/aurat-jaat.mp4",          thumbnailTime: 0.1 },
  { id: 10, client: "Thanks Giving",     subtitle: "Welcoming Video",   videoUrl: "/videos/thanksgiving.mp4",        thumbnailTime: 3.1 },
  { id: 11,  client: "Rangrezz-Alfaaz",   subtitle: "Promotional Video", videoUrl: "/videos/rangrezz-alfaaz.mp4",     thumbnailTime: 1.1 },
  { id: 12,  client: "Finance",           subtitle: "Documentary",       videoUrl: "/videos/finance-documentary.mp4", thumbnailTime: 0.1 },
...
const Hero = () => {
  ...
  const openFullscreen = useCallback((id: number) => {
  ...
  const handleCardClick = useCallback(
    (id: number) => {
      ...
      if (id === activeId) { openFullscreen(id); return; }
                    ...
                    <div className="relative aspect-video">
                      ...
                      {isActive && (
                        <motion.button
                          ...
                          onClick={(e) => { e.stopPropagation(); openFullscreen(project.id); }}
                        >
